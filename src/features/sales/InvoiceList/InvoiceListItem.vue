...
<template>
  <button
    ...
    :class="
      twMerge(
        'grid w-full cursor-pointer grid-cols-[1fr_min-content] items-center border border-transparent px-6 py-5 text-left transition-all hover:bg-neutral-100 dark:hover:bg-neutral-800',
        isActive &&
